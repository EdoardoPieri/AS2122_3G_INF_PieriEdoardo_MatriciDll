...
namespace AS2122_3G_INF_PieriEdoardo_MatriciDll
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            medio = matr.CalcolaMinMaxMedio(matr, ref min, ref max);
